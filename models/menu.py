...
response.menu = [(T('Home'), False, URL('default', 'index'),[]),
    ...
    (SPAN('Test'),False,URL('default','index'),[(T('IQ Level_1'),False,URL('default','iq1')),(T('IQ Level_2'),False,URL('default','iq2'))]),
     (SPAN('Scoreboard'),False,URL('default','rank'),[(T('Overall Scoreboard'),False,URL('default','rank')),(T('IQ Level_1 scoreboard'),False,URL('default','rank3')),(T('IQ Level_2 scoreboard'),False,URL('default','rank4'))]),
     (T('Contact_us'), False, URL('default', 'contact'),[]),
     (T('Forum'), False, URL('default', 'kirti'),[])
]
